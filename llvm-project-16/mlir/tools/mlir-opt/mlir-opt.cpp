...
void registertosaGenChain();
//void registerTestReplacePass();
void registerBcfPass();
//void registerSubPass() ;
void registerTGPass();
//void registerAttrGenPass();
void registerGetDialectName();
void registerMixPass();
//void registerNSPass();
//void registerNRPass();
//void registerNCPass();
} // namespace test
...
void registerTestPasses() {
  ...
  mlir::test::registertosaGen();
  mlir::test::registertosaGenU();
  mlir::test::registertosaGenChain();
  mlir::test::registerBcfPass();
//  mlir::test::registerSubPass();
  mlir::test::registerTGPass();
//  mlir::test::registerAttrGenPass();
  mlir::test::registerGetDialectName();
  mlir::test::registerMixPass();
//  mlir::test::registerNSPass();
//  mlir::test::registerNRPass();
//  mlir::test::registerNCPass();
